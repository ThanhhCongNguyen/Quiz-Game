...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder> {
    ...
    IntentToQuizActivity intentToQuizActivity;

    public CategoryAdapter(Context context, ArrayList<CategoryModel> categoryModels, IntentToQuizActivity intentToQuizActivity) {
        this.context = context;
        this.categoryModels = categoryModels;
        this.intentToQuizActivity = intentToQuizActivity;
    }
...
//                context.startActivity(intent);
                intentToQuizActivity.intentToQuizActivity(categoryModel.getCategoryId(), categoryModel.getCategoryName());
